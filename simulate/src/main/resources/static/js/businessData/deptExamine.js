...
function toEdit(data){
	...
	layerid = layer.open({
		...
		area: ['80%', '90%'],
		content: 'busi/deptExamine/toBusinessDataAdd?type=2&id='+data ,
 ...
 function pageInit() {
	 ...
	 layui.use('table', function(){
		  tableid = layui.table.render({
		    ...
		    ,url:'busi/deptExamine/businessDataList'
		    ,method:'post'
		    ,cols: [[
		    	 {type:'checkbox'}
	...
	$("#examineListYes").click(function () {
    	...
    	var orderNosList = new Array();
     	if(selectData.data.length > 0){
	     	...
	     	deptExamine(orderNosList,"busi/deptExamine/examineYes","1");
     	} else {
	...
	$("#examineListNo").click(function () {
    	...
    	var orderNosList = new Array();
     	if(selectData.data.length > 0){
	     	...
	     	deptExamine(orderNosList,"busi/deptExamine/examineNo","1");
     	} else {
     		layer.alert("请选择要审批的记录");
     	}
	});
	...
	$("#deptExamineYes").click(function () {
		...
		var orderNosList = new Array();
		orderNosList[0] = id;
		deptExamine(orderNosList,"busi/deptExamine/examineYes","2");
		return false;
	});
	...
	$("#deptExamineNo").click(function () {
		...
		var orderNosList = new Array();
		orderNosList[0] = id;
		deptExamine(orderNosList,"busi/deptExamine/examineNo","2");
		return false;
	});
