...
<script src="${basePath!}/static/js/businessData/leaderExamine.js" type="text/javascript"></script>
<base href="${basePath!}/">
    ...
    <form class="layui-form" action="" id="addeditformid">
        ...
        <#if businessList??>
			<#list businessList as business>
				 <div class="layui-form-item" style="text-align:left">
			        ...
			        <input type="text" id="num" name="num"  placeholder="请输入数量" class="layui-input" maxlength="30" autocomplete="off" disableautocomplete style="width:12%;text-align:left;float:left" lay-verify="num" value="${business.num!}" disabled="disabled">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
			   <textarea id="remarks" name ="remarks" placeholder="请输入内容" class="layui-textarea" maxlength="85" disabled="disabled">${businessData.remarks!}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
             	<button class="layui-btn" id="deptExamineYes">审批通过</button>
                <button class="layui-btn" id="deptExamineNo">审批不通过</button>
            </div>
        </div>
    </form>
</div>
